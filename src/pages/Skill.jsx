...
const Skill = () => {
  return (
    <motion.div className='grid grid-cols-2 items-center lg:h-screen justify-items-center pt-20' initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ ease: 'easeOut' }}>
      <h2>this is skill</h2>
